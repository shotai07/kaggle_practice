...
# pytorch_tutorial documentation build
...
from pytorch_tutorial import __version__ as release

# -- Project information -----------------------------------------------------

project = "pytorch_tutorial"
author = "Kedro"
...
htmlhelp_basename = "pytorch_tutorialdoc"
...
latex_documents = [
    (
        master_doc,
        "pytorch_tutorial.tex",
        "pytorch_tutorial Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pytorch_tutorial",
        "Project pytorch_tutorial codebase.",
        "Data-Science",
    )
]
